...
<section class="timeline-section fade-in-section">
  <div class="timeline-card">
    ...
    <div style="overflow-x:auto; margin:16px 0 8px; padding:0 8px;">
      <div style="position:relative; min-width:700px; height:110px;">
...
def generate_city_page(city_data: dict, glofas_data: dict) -> None:
    ...
    CITY_EMOJI = {
        "orel": "\U0001f985",       # орёл
        "mtsensk": "\U0001f3f0",     # крепость
        "belev": "\U0001f34e",       # яблоко
        "chekalin": "\U0001f3d8\ufe0f", # малый город
        "kozelsk": "\u2694\ufe0f",   # мечи
        "kaluga": "\U0001f680",      # ракета
        "aleksin": "\U0001f3ed",     # промышленность
        "tarusa": "\U0001f3a8",      # художники
        "serpuhov": "\U0001f99a",    # павлин
        "pushchino": "\U0001f52c",   # наукоград
        "kashira": "\u26a1",         # электростанция
        "kolomna": "\U0001f9f1",     # кремль
    }
    city_emoji = CITY_EMOJI.get(slug, "")
...
<div style="padding: 32px 0 20px;">
  ...
  <h1 style="font-size:2.5rem; font-weight:800; letter-spacing:-0.04em; margin-bottom:10px;">{f'<span style="font-size:1.4em">{city_emoji}</span> ' if city_emoji else ''}{_h(name)}</h1>
